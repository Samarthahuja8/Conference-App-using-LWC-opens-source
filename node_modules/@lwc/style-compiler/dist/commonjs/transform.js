...
function transform(src, id, config = {}) {
    ...
    const allowDefinition = Boolean(!config.customProperties || config.customProperties.allowDefinition);
    ...
    const result = postcss_1.default(plugins).process(src, { from: id }).sync();
